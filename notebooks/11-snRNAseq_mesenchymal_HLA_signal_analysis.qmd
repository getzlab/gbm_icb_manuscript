...
```{r Ex.Fig.8b-MES-signal-source-vs-survival}
...
plot_data <- bivariate_results %>%
  mutate(
    ...
    hr_ci_str = sprintf("%.2f (%.2f–%.2f)", hr, conf.low, conf.high),
...
```{r Fig.5g-HLA-class-I-scores-by-malignant-subtype}
...
```{r Fig.5b-Verhaak-classification-expression-by-patient}
...
```{r Ex.Fig.8c-left-HLA-class-I-signal-by-cell-type-in-MES-vs-non-MES-samples}
...
# ============================================================================
# ANALYSIS: Fraction of HLA Class I signal by cell type
# ============================================================================
...
```{r Fig.5h-compare-bulk-expression-HLA-class-II-scores-by-malignant-cell-state}
