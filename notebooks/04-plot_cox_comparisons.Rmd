...
Run this notebook to generate Figure 3a, 3d.

The notebook
* Runs Cox regression on genomic variants in the GLASS and ICB cohorts
* Generates a scatterplot comparing their hazard ratios.
```{r}
library(tidyverse)
library(ggrepel)
library(ggpubr)
...
p_combined %>% ggsave(filename = paste0(output_folder, '3AD.cox_combined.png'),
             dpi = 450, width = 11, height = 7, units = 'in')
p_combined %>% ggsave(filename = paste0(output_folder, '3AD.cox_combined.pdf'),
             width = 11, height = 7)
